...
<body style="background-color:#f7d7bc">
    ...
    <center>
            <div  class="row">
                <div class="col" id="banner">
                    <h1 style="font-family:coolvetica;color: beige;font-size: 4rem;text-align: left;padding-left: 2rem;padding-top: 18rem;">About Us .</h1>
                    <h1 style="font-family:coolvetica;color: beige;font-size: 1.5rem;text-align: left;padding-left: 2rem;margin-top: -2.5rem;">Sedikit lebih jauh mengenai latar belakang toko berkah jaya.</h1>
                </div>
            </div>
    </center>
    ...
    <div id="awal1" class="row" style="margin-top: 60px;">
        <center>
        <div class="col-3" style="height: 30rem;object-fit: contain;">
    ...
    <div class="row">
        <center><div style="height:1px;width: 95%;background-color: black;margin-top: 40px;"></div></center>
    </div>
    ...
    <div class="row" style="margin-top:60px">
        ...
        <div class="col-6">
            ...
            <p style="font-family:coolvetica ;font-size: 1rem;">Christina Lelaona<br>Owner Berkah Jaya Baby Shop</p>
        </div>
        </center>
        <center>
        <div class="col-6">
    ...
    <div class="row" id="contact" style="margin-top: 40px">
        <center><h1 style="font-family:coolvetica">Contact / Where you can find us</h1></center>
    </div>

    <center>
        <div class="row" style="margin-top:20px;width:80%;height:250px;">
            <a href="https://tokopedia.com"><center><div class="col-4"><img src="images/tokped2.png" style="height:50%;width: 50%;object-fit: contain;"></div></center></a>
            <a href="https://shopee.co.id"><center><div class="col-4"><img src="images/shopee.png" style="height:50%;width: 50%;object-fit: contain;"></div></center></a>
            <a href="https://instagram.com"><center><div class="col-4"><img src="images/ig.png" style="height:55%;width: 55%;object-fit: contain;"></div></center> </a> 
        </div>
    </center>

    <center>
        <div class="row" style="margin-top:80px">
            <center><a href="https://goo.gl/maps/KKsrqCRithfcGzXs9"><img src="images/map1.png" style="border-radius:5px;height:55%;width: 55%;"></a></center>
            <p style="font-family:coolvetica;">Map Berkah Jaya 1 (Pasar Krian, Jl. Basuki Rahmat No. 11, Krian, Kec. Krian, Kabupaten Sidoarjo, Jawa Timur 61262)</p>
        </div>
    </center>

    <center>
        <div class="row" style="margin-top:40px">
            <a href="https://goo.gl/maps/UMAuaf4avpkq6J3o9"><img src="images/map2.png" style="border-radius:5px;height:55%;width: 55%;"></a>
            <center>
            <p style="font-family:coolvetica;">Map Berkah Jaya 2 (Jl. Gubernur Sunandar No. 578, Krian, Kec. Krian, Kabupaten Sidoarjo, Jawa Timur 61226)</p></center>
        </div>
    </center>
